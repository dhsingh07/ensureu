...
@Document(collection = "freePaperCollection")
public class FreePaperCollection extends Paper<Sections<SubSections<Question<Problem>>>> implements Comparable<FreePaperCollection>{
	...
	@Override
	public int compareTo(FreePaperCollection o) {
