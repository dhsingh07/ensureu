...
@Document(collection = "paidPaper")
public class PaidPaper extends UserPaper implements Serializable{
	
/**
	 * 
	 */
private static final long serialVersionUID = 1420181617241530820L;
...
private PaidPaperCollection paper;
...
public PaidPaperCollection getPaper() {
	return paper;
}
public void setPaper(PaidPaperCollection paper) {
	this.paper = paper;
}
...
public String toString() {
	return "PaidPaper [id=" + id + ", paperId=" + paperId + ", userId=" + userId + ", paperStatus=" + paperStatus
			+ ", paper=" + paper + ", paperSubCategoryName=" + paperSubCategoryName + ", paperName=" + paperName
			+ ", paperType=" + paperType + ", paperCategory=" + paperCategory + ", paperSubCategory=" + paperSubCategory
			+ ", testType=" + testType + ", totalSkipedCount=" + totalSkipedCount + ", totalCorrectCount="
			+ totalCorrectCount + ", totalInCorrectCount=" + totalInCorrectCount + ", totalAttemptedQuestionCount="
			+ totalAttemptedQuestionCount + ", payment=" + payment + ", price=" + price + ", paperValidityStartDate="
			+ paperValidityStartDate + ", paperValidityEndDate=" + paperValidityEndDate + ", startTestTime="
			+ startTestTime + ", endTestTime=" + endTestTime + ", totalTimeTaken=" + totalTimeTaken + ", totalScore="
			+ totalScore + ", totalGetScore=" + totalGetScore + ", totalTime=" + totalTime + ", negativeMarks="
			+ negativeMarks + ", perQuestionScore=" + perQuestionScore + ", totalQuestionCount=" + totalQuestionCount
