...
@Document(collection="quizPaperCollection")
public class QuizPaperCollection extends Paper<Sections<SubSections<Question<Problem>>>> implements Comparable<QuizPaperCollection> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9086502833718761022L;
	private String id;
...
@Override
public int compareTo(QuizPaperCollection arg0) {
