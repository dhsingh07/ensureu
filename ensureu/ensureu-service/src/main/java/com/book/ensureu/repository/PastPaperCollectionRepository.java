...
@Repository
public interface PastPaperCollectionRepository extends MongoRepository<PastPaperCollection, String> {
	
	public Optional<PastPaperCollection> findById(String id);

	public List<PastPaperCollection> findByPaperType(String paperType);
	...
	public List<PastPaperCollection> findByIdListIns(List<String> ids) throws Exception;
	...
	public List<PastPaperCollection> findByPaperTypeAndPaperCategory(PaperType paperType,PaperCategory paperCategory);
