...
@Document(collection="purchaseSubscriptions")
public class PurchaseSubscriptions {
	...
	public String toString() {
		return "PurchaseSubscriptions [id=" + id + ", listOfSubscriptionIds=" + listOfSubscriptionIds + ", userId=" + userId
