...
@Document(collection="quizPaper")
public class QuizPaper implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 9131568203654355682L;
	@Id
	private Long id;
	...
	private QuizPaperCollection paper;
	...
	public QuizPaperCollection getPaper() {
		return paper;
	}
	public void setPaper(QuizPaperCollection paper) {
		this.paper = paper;
	}
	...
	public String toString() {
		return "QuizPaper [id=" + id + ", paperId=" + paperId + ", paperHashKey=" + paperHashKey + ", userId=" + userId
	...
	public int hashCode() {
		...
		result = prime * result + ((paperCategory == null) ? 0 : paperCategory.hashCode());
		return result;
	}
	@Override
	public boolean equals(Object obj) {
		...
		if (paper == null) {
			...
			return false;
		if (paperCategory != other.paperCategory)
			return false;
		return true;
	}
	
	/*
	 * //for pastpaper private long dateOfExam; private String dateOfExamYear;
	 * private String shiftOfExam; private double cutOffMark;
	 */
