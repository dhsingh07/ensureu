...
@Document(collection = "practicePaperCollection")
public class PracticePaperCollection extends Paper<Sections<SubSections<Question<Problem>>>> implements Comparable<PracticePaperCollection>{

	/**
	 * 
	 */
	private static final long serialVersionUID = -9047405667136413474L;
	/**
	 * 
	 */
	...
	public String getPaperValue() {
		return this.paperType.toString()+this.id;
	}
	...
	@Override
	public int compareTo(PracticePaperCollection o) {
		return getPaperValue().compareTo(o.getPaperValue());
	}
	...
	public String toString() {
		return "FreePaperCollection [id=" + id + ", paperType=" + paperType + ", paperSubCategory=" + paperSubCategory
